          ...
          <div>
            ...
            <div class="flex items-center justify-between mt-6">
              ...
              <div>
                <button
                  type="button"
                  class="inline-flex mr-2 text-white items-center bg-green-600 hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-3 py-2 focus:outline-none"
                >
                  Buy Now
                </button>
                <button
                  type="button"
                  class="inline-flex text-white items-center bg-blue-600 hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-3 py-2 focus:outline-none"
                >
          ...
          <div className="mt-6">
            {reviews?.map((review) => (
              <figure class="max-w-screen-md border rounded-lg mt-3 p-4 border-gray-400">
                ...
                <blockquote>
                  <p class="text-xl text-heading tracking-tight">
                    "{review.comment}"
                  </p>
                </blockquote>
