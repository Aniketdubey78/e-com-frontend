  ...
  return (
    <div className="container mx-auto">
      ...
      <div className=" flex justify-center flex-wrap">
        {items.length === 0 ? (
          <div>
            <h1>Not Single Item Is Selected In Wishlist</h1>
          </div>
        ) : (
          items.map((product) => (
          <div class="w-full max-w-md bg-neutral-primary-soft p-3 border-default rounded-base">
            ...
            <div>
              ...
              <button
                type="button"
                class="inline-flex mt-3 text-white items-center bg-blue-600 hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-3 py-2 focus:outline-none"
              >
                <svg
